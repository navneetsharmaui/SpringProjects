 ...
 * 
 */
package com.mindtree.springfive.autowiring.annotations;
...
@Component (value="customerAutowire")
public class CustomerAutowire {
	 ...
	 */
	public CustomerAutowire(String customerName, int customerID, Address customerAddress) {
